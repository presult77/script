...
tls=$(cat /etc/xray/grpc/vmessgrpc.json | grep port | sed 's/"//g' | sed 's/port//g' | sed 's/://g' | sed 's/,//g' | sed 's/       //g' | sed 's/      //g')
none=$(cat /etc/xray/grpc/vlessgrpc.json | grep port | sed 's/"//g' | sed 's/port//g' | sed 's/://g' | sed 's/,//g' | sed 's/       //g' | sed 's/      //g')
echo -e "======================================"
...
if [[ -z $cek ]]; then
sed -i "s/$tls/$tls1/g" /etc/xray/grpc/vmessgrpc.json
...
if [[ -z $cek ]]; then
sed -i "s/$none/$none1/g" /etc/xray/grpc/vlessgrpc.json
